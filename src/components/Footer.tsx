        ...
        <footer id="footer">
            <div className="bg-lime-500 py-20 flex flex-col md:flex-row justify-around px-6">
                <div>
                    ...
                    <div className="flex flex-row flex-wrap justify-around gap-2 md:gap-4 mt-20 ml-0 md:ml-6">
                        <a
                ...
                <iframe
                    ...
                    loading="lazy"
                    className="border-2 border-slate-700 rounded-2xl mx-auto mt-10 md:ml-20 h-64 w-5/6 md:h-96 md:w-2/5"
                ></iframe>
            </div>
        </footer>
    );
